...
class FetchForethoughtService {
     ...
     */
    async processMessage(message, category, userContext, sessionId) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.widgetUrl}/api/v1/conversations`, {
                message,
     ...
     */
    buildFetchDataAttributes(category, context) {
        const data = {
     ...
     */
    generateCategoryResponse(message, category, context, processingTime) {
     ...
     */
    parseResponse(data, processingTime) {
        return {
...
//# sourceMappingURL=fetchForethoughtService.js.map