...
exports.FETCH_PERSONAS = [
    ...
    // Receipt Issues Personas
    {
        ...
        description: 'Multiple receipts rejected, doesn', t, understand, why, ',: category, 'receipt_issues': ,
...
function getPersonasByCategory(category) {
    return exports.FETCH_PERSONAS.filter(p => p.category === category);
}
/**
 * Get a random persona for testing
 */
function getRandomPersona(category) {
    const personas = category ? getPersonasByCategory(category) : exports.FETCH_PERSONAS;
    return personas[Math.floor(Math.random() * personas.length)];
}
/**
 * Get test scenarios for each category
 */
exports.FETCH_TEST_SCENARIOS = {
    missing_points: [
        {
...
//# sourceMappingURL=fetchPersonas.js.map