...
exports.FETCH_PERSONAS = [
    ...
    // Receipt Issues Personas
    {
        ...
        description: 'Multiple receipts rejected, doesn',
        t: t,
...
function getPersonasByCategory(category) {
    return exports.FETCH_PERSONAS.filter(function (p) { return p.category === category; });
}
/**
 * Get a random persona for testing
 */
function getRandomPersona(category) {
    var personas = category ? getPersonasByCategory(category) : exports.FETCH_PERSONAS;
